...
def resizeIm(im, targetSize):
    return F.interpolate(im, size = [targetSize, targetSize], mode = 'bilinear')
...
parser.add_argument('--FMInputSize', type=int, default=64, help='image size which feature extractor gets as input')
